...
import argparse, os, re, shutil, sys, text_to_speach
...
if __name__ == '__main__':
    ...
    if not args.skip_numbers:
        for i in range(1,256):
            ...
            text_to_speach.textToSpeechUsingArgs(text='{}'.format(i), targetFile=targetFile1, args=args)
    ...
    with open(audioMessagesFile) as f:
        ...
        for line in f:
            ...
            if match:
                ...
                text = match.group(2)
                text_to_speach.textToSpeechUsingArgs(text=text, targetFile=targetDir + '/mp3/' + fileName, args=args)
